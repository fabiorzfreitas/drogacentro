    ...
    for product in internal:
        if product in external:
            ...
            internal_compared_catalog[product] = {
                ...
                "drogaven": external[product]["Drogaven"],
                "drogal": external[product]["Drogal"],
                "drogaraia": external[product]["DrogaRaia"],
            }
        else:
            internal_compared_catalog[product] = {
                "ean": product,
...
def main():
    ...
    with warnings.catch_warnings():
        ...
        df = pd.read_excel(
            sheet_file, usecols="A, B, C, J, Q", dtype=str, engine="openpyxl"
        )
    ...
    internal_as_dict = {
        product_row["ean"]: product_row for product_row in internal_as_list
    }
